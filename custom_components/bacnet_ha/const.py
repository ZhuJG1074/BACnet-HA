...
DEFAULT_DEVICE_ID: int = 9600
DEFAULT_DEVICE_INSTANCE: int = 3900000
DEFAULT_MSRTP_NETWORK: int = 11  # BACnet MS/TP network number
DEFAULT_MSRTU_MAC: int = 16      # MS/TP device MAC address
DEFAULT_POLLING_INTERVAL: int = 30
DEFAULT_ENABLE_COV: bool = False
